...
الحمدُ لله الذي بنعمته تتمّ الصالحات، أحمده سبحانه حمدًا كثيرًا طيبًا مباركًا فيه، فقد منَّ عليَّ بإتمام مشوارٍ جامعيٍّ جديد تُوِّج بنيل شهادة الليسانس، فله الحمد أولًا وآخرًا على ما وفّق ويسّر. وأسأله عزّ وجلّ أن يرزقني علمًا نافعًا أُفيد به غيري، وأن يجعل ما تعلمناه وعملنا به في ميزان حسناتنا.
...
\noindent
يتناول هذا المشروع تصميم وتطوير تطبيق هاتف محمول يُدعى «Allo Artisan»، يهدف إلى تسهيل عملية الربط بين الزبائن والحرفيين في الجزائر.
...
يوفّر التطبيق مجموعة من الخصائص الأساسية، من بينها: التحقق من هوية الحرفي باستخدام رمز QR، التحقق من الشهادات والوثائق المهنية، نظام بحث متعدد المعايير، تقويم لتحديد فترات التوفر، بالإضافة إلى نظام للمنشورات والإشعارات الخاصة بطلبات الخدمات العادية والمستعجلة.

من الناحية التقنية، تم تطوير التطبيق باستخدام Flutter لتطوير واجهة الهاتف المحمول، وGo (Golang) لتطوير الجزء الخلفي وإنشاء واجهة API REST، إضافةً إلى PostgreSQL كنظام لإدارة قواعد البيانات، مع استخدام Docker لضمان نشر مستقر وقابل للنقل.
...
\section*{Logo of the application}

\vfill

\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth,height=0.3\textheight,keepaspectratio]{figures/_first_page/logo.jpg}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{figures/_first_page/register_step1.jpg}
        \caption{Step 1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[c]{0.3\textwidth}
...
their key limitations and define a clear problem statement.
\newline
This study guided us in 
...
implemented using \textbf{Flutter} for the frontend, \textbf{Go (Golang)} for the backend, with \textbf{PostgreSQL} as the database management system. \newline
